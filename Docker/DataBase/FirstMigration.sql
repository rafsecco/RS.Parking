...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20221125093921_Initial') THEN
...
BEGIN
    ...
    VALUES (1, 0, TRUE, TIMESTAMP '2022-11-25 06:39:20', 'No Discount', 0.0);
    INSERT INTO `tb_AccordType` (`id_accord`, `ie_accord`, `bln_active`, `dt_dateCreated`, `ds_accord`, `nr_percentage`)
    VALUES (2, 0, TRUE, TIMESTAMP '2022-11-25 06:39:20', 'PharmaTech', 0.0);
    INSERT INTO `tb_AccordType` (`id_accord`, `ie_accord`, `bln_active`, `dt_dateCreated`, `ds_accord`, `nr_percentage`)
    VALUES (3, 1, TRUE, TIMESTAMP '2022-11-25 06:39:20', 'Subway', 50.0);
    INSERT INTO `tb_AccordType` (`id_accord`, `ie_accord`, `bln_active`, `dt_dateCreated`, `ds_accord`, `nr_percentage`)
    VALUES (4, 2, TRUE, TIMESTAMP '2022-11-25 06:39:20', 'McDonald''s', 100.0);
...
BEGIN
    ...
    VALUES (1, 1, TIMESTAMP '2022-11-25 06:39:20', NULL, 'BRL-123', 1);
    INSERT INTO `tb_ControlInOut` (`id_controlInOut`, `cd_accord`, `dt_in`, `dt_out`, `ds_licensePlate`, `cd_vehicle`)
    VALUES (2, 1, TIMESTAMP '2022-11-25 06:39:20', NULL, 'BRL-456', 2);
...
BEGIN
    ...
    VALUES (1, TRUE, 5.0, TIMESTAMP '2022-11-25 06:39:20', 'Car 1');
    INSERT INTO `tb_VehicleType` (`id_vehicle`, `bln_active`, `vl_cost`, `dt_dateCreated`, `ds_vehicle`)
    VALUES (2, TRUE, 5.5, TIMESTAMP '2022-11-25 06:39:20', 'Car 2');
    INSERT INTO `tb_VehicleType` (`id_vehicle`, `bln_active`, `vl_cost`, `dt_dateCreated`, `ds_vehicle`)
    VALUES (3, TRUE, 3.0, TIMESTAMP '2022-11-25 06:39:20', 'Moto 1');
    INSERT INTO `tb_VehicleType` (`id_vehicle`, `bln_active`, `vl_cost`, `dt_dateCreated`, `ds_vehicle`)
    VALUES (4, TRUE, 3.5, TIMESTAMP '2022-11-25 06:39:20', 'Moto 2');
...
BEGIN
    ...
    VALUES ('20221125093921_Initial', '6.0.7');
